...
public class PatientKnowledgeExtractorJess implements PatientKnowledgeExtractorInterface {
	...
	public PatientKnowledgeExtractorJess() {
	}
	...
	public void setPatients(
			List<org.healthnlp.deepphe.summarization.jess.kb.Patient> patients) {
