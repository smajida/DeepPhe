...
public class CasPreLoadedPatientAE extends JCasAnnotator_ImplBase {

	private JCas multiJCas;
	private JCas patientJCas;
	private KbPatient patient;
	private Rete jessEngine;
	private final HashMap<Integer, KbIdentified> knowledgeMap = new HashMap<>();
		...
		try {
			if (jessEngine == null) {
				...
				File productionClipsDirectory = new File(
						"C:/ws/ws-deepphe-6/DeepPhe/deepphe-uima/src/main/jess/autoload");
