...
import org.healthnlp.deepphe.summarization.drools.kb.RelationHasbodyLocation;
...
public class TesterBreastCancerMetastasis {
	...
	public void testMet1() {
		...
		M1StageFinding m1StageFinding = new M1StageFindingImpl();
		m1StageFinding.setId(idCounter++);
		m1StageFinding.setSummarizableId(patient.getId());
		
		FactHandle handleGoal = session.insert(goal);
		FactHandle handlePatient = session.insert(patient);
		FactHandle handleM1StageFinding = session.insert(m1StageFinding);
		...
		session.retract(handleM1StageFinding);
	...
	public void testMet2() {
	    ...
	    RelationHasbodyLocation hasBodyLocationOne = new RelationHasbodyLocationImpl();
	    ...
	    RelationHasbodyLocation hasBodyLocationTwo = new RelationHasbodyLocationImpl();
