...
public class TesterBreastCancerReceptorStatus {
	...
	public void testHer2NeuReceptorStatus() {
		...
		Her2neuReceptorStatus her2NeuStatus = new Her2neuReceptorStatusImpl();
	...
	public void testTriplePositiveReceptorStatus() {
		...
		HasInterpretation erHasInterpretation = new HasInterpretationImpl();
		...
		HasInterpretation prHasInterpretation = new HasInterpretationImpl();
		...
		HasInterpretation her2NeuHasInterpretation = new HasInterpretationImpl();
