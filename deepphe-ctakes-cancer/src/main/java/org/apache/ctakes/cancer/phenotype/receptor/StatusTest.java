...
enum StatusTest implements Test {
   IHC( "Immunohistochemistry", OwlConstants.BREAST_CANCER_OWL + "#" + "Immunohistochemical_Test" ),
...
//   IHC_HER2("Unknown Diagnostic Test", OwlOntologyConceptUtil.SCHEMA_OWL + "#" + "DiagnosticProcedure" ),
   FISH( "Fluorescence in situ Hybridization",
         OwlConstants.BREAST_CANCER_OWL + "#" + "Fluorescence_In_Situ_Hybridization" ),  //her2
   CISH( "Chromogenic in situ Hybridization",
         OwlConstants.BREAST_CANCER_OWL + "#" + "Chromogenic_In_Situ_Hybridization" ),
   DISH( "Dual int situ Hybridization", OwlConstants.SCHEMA_OWL + "#" + "DiagnosticProcedure" ),  //her2
   //   SERUM_HER2( "Unknown Diagnostic Test", OwlOntologyConceptUtil.SCHEMA_OWL + "#" + "DiagnosticProcedure" ),
   UNSPECIFIED( "Unknown Diagnostic Test", OwlConstants.SCHEMA_OWL + "#" + "DiagnosticProcedure" );
