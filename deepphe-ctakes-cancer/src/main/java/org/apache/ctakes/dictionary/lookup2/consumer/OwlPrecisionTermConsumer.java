 ...
 * @since 10/24/2014
 */
public class OwlPrecisionTermConsumer extends AbstractTermConsumer {

   static private final Logger LOGGER = Logger.getLogger( "OwlCleanupTermConsumer" );
   ...
   static private boolean isInRoot( final Long cuiI, final Long cuiJ,
      ...
      final Collection<String> uriRootsI = new HashSet<>( cuiUriRoots.get( cuiI ) );
      uriRootsI.removeAll( cuiUriRoots.get( cuiJ ) );
      return uriRootsI.isEmpty();
   }
