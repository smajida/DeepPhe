...
public class XMIWriter extends CasConsumer_ImplBase {
	...
	public void process(CAS aCAS) throws AnalysisEngineProcessException {
		...
		if (originalFileName != null && !originalFileName.isEmpty()
			...
			/*
			 * File inFile; try { String outFileName = null; if (
			 * originalFileName.contains( "/" ) ) { URI uri = UriUtils.quote(
			 * originalFileName ); inFile = new File( uri ); outFileName =
			 * inFile.getName(); } else { outFileName = originalFileName; }
			 * outFileName += ".xmi"; outFile = new File( mOutputDir,
			 * outFileName );
			 * 
			 * } catch ( URISyntaxException e ) { // bad URI, use default
			 * processing below }
			 */
	...
	public static CasConsumerDescription getDescription() throws InvalidXMLException {
		InputStream descStream = XMIWriter.class.getResourceAsStream("XmiWriter.xml");
