...
public class Cancer extends Diagnosis {
	...
	private static final long serialVersionUID = -5774502642271137850L;
	
	protected List<Tumor> tumors = new ArrayList<Tumor>();
	...
	public static class Tumor extends BackboneElement  {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 3238334048997684426L;
		
		
		protected CodeableConcept type;
		protected List<ConditionLocationComponent> location = new ArrayList<ConditionLocationComponent>();
		protected List<ConditionEvidenceComponent> genomicFactors = new ArrayList<ConditionEvidenceComponent>();
		protected List<ConditionEvidenceComponent> treatmentFactors = new ArrayList<ConditionEvidenceComponent>();
		protected List<ConditionEvidenceComponent> relatedFactors = new ArrayList<ConditionEvidenceComponent>();
		protected List<ConditionEvidenceComponent> phenotypicFactors = new ArrayList<ConditionEvidenceComponent>();
